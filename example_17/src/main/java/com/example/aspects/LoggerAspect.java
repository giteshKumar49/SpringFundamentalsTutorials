...
@Aspect       // Mandatory annotation for AOP
@Component    // Mandatory annotation for AOP
@Order(2)     // Defines order of the aspect, ie. order in which AOP logic will run...
public class LoggerAspect {
    ...
    public void log(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        joinPoint.proceed(); // this will tell spring framework that we are done with out before logic
                             // and now execute the actual method, and now give back the control to me
                             // to execute the after logic.......
